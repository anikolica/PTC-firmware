...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/scripts/settings.tcl"]"\
  ...
  set files [list \
 "[file normalize "$origin_dir/src/PWM.v"]"\
 "[file normalize "$origin_dir/src/clock_div.v"]"\
 "[file normalize "$origin_dir/src/demux.v"]"\
 "[file normalize "$origin_dir/src/Mercury_XU5_LED_timing.xdc"]"\
...
set orig_proj_dir "[file normalize "$origin_dir/Mercury_XU5_PE1"]"
...
set file "$origin_dir/src/clock_div.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/demux.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/src/Mercury_XU5_LED_timing.xdc"]" -objects $obj
set_property -name "target_part" -value "xczu5ev-sfvc784-2-i" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/src/Mercury_XU5_LED_timing.xdc"]" -objects $obj
...
proc cr_bd_Mercury_XU5 { parentCell } {
  ...
  set_property CONFIG.C_S_AXI_ACLK_FREQ_HZ {99999001} $axi_uartlite_0
...
\
  ...
  connect_bd_intf_net -intf_net axi_iic_0_IIC [get_bd_intf_ports iic_wib] [get_bd_intf_pins axi_iic_0/IIC]
  connect_bd_intf_net -intf_net axi_iic_1_IIC [get_bd_intf_ports iic_ptc] [get_bd_intf_pins axi_iic_1/IIC]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M03_AXI [get_bd_intf_pins axi_iic_0/S_AXI] [get_bd_intf_pins smartconnect_0/M03_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M05_AXI [get_bd_intf_pins axi_uartlite_0/S_AXI] [get_bd_intf_pins smartconnect_0/M05_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_1_M01_AXI [get_bd_intf_pins axi_iic_1/S_AXI] [get_bd_intf_pins smartconnect_1/M01_AXI]
  ...
  connect_bd_net -net axi_iic_0_iic2intc_irpt [get_bd_pins axi_iic_0/iic2intc_irpt] [get_bd_pins zynq_ultra_ps_e/pl_ps_irq0]
  connect_bd_net -net axi_iic_1_iic2intc_irpt [get_bd_pins axi_iic_1/iic2intc_irpt] [get_bd_pins zynq_ultra_ps_e/pl_ps_irq1]
  ...
  connect_bd_net -net ps_sys_rst_peripheral_aresetn [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_iic_1/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins led/s_axi_aresetn] [get_bd_pins ps_sys_rst/peripheral_aresetn] [get_bd_pins system_management_wiz/s_axi_aresetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_pl_clk0 [get_bd_ports Clk100] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_iic_1/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins led/s_axi_aclk] [get_bd_pins ps_sys_rst/slowest_sync_clk] [get_bd_pins reg_bank_0/s00_axi_aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk1] [get_bd_pins system_management_wiz/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e/pl_clk0]
  ...
  assign_bd_address -offset 0x80030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs axi_iic_0/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs axi_iic_1/S_AXI/Reg] -force
  assign_bd_address -offset 0x80050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] -force
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Mercury_XU5_PE1.srcs/utils_1/synth_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
set_property -name "strategy" -value "Vivado Synthesis Defaults" -objects $obj
set_property -name "steps.synth_design.tcl.pre" -value "$proj_dir/Mercury_XU5_PE1.srcs/utils_1/imports/scripts/settings.tcl" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/Mercury_XU5_PE1.srcs/utils_1/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Mercury_XU5_PE1.srcs/utils_1/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
set_property -name "strategy" -value "Vivado Implementation Defaults" -objects $obj
set_property -name "steps.init_design.tcl.pre" -value "$proj_dir/Mercury_XU5_PE1.srcs/utils_1/imports/scripts/settings.tcl" -objects $obj
...
set_property -name "ml_strategy_runs" -value "" -objects $obj
set_property -name "auto_rqs" -value "0" -objects $obj
set_property -name "auto_rqs.directory" -value "$proj_dir/Mercury_XU5_PE1.srcs/utils_1/impl_1_copy_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Mercury_XU5_PE1.srcs/utils_1/impl_1_copy_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
set_property -name "strategy" -value "Vivado Implementation Defaults" -objects $obj
set_property -name "steps.init_design.tcl.pre" -value "$proj_dir/Mercury_XU5_PE1.srcs/utils_1/imports/scripts/settings.tcl" -objects $obj
set_property -name "steps.init_design.tcl.post" -value "" -objects $obj
