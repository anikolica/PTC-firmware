...
//#define P_LED7 P5_3
//#define P_LED8 P3_11
#define P_LED1 P0_1 // 1
#define P_LED2 P0_0 // 2
#define P_LED3 P3_6 // 90
#define P_LED4 P0_9
#define P_LED5 P3_5 // 91
#define P_LED6 P3_4 // 92
#define P_LED7 P0_6 // 96
#define P_LED8 P14_5
#define P_BUT1 P14_4
#define P_BUT2 P14_3
...
void Init_Relax_Button ()
{
  ...
  XMC_GPIO_SetMode(P_BUT1, XMC_GPIO_MODE_INPUT_TRISTATE);
  /* Enable digital input. Only needed because P15.13 is an analog port */
  XMC_GPIO_EnableDigitalInput(P_BUT1);

  /* INITIALIZE BUTTON2 ON PORT 5.12 FOR INPUT */
  /* Set mode to input tristate */
  XMC_GPIO_SetMode(P_BUT2, XMC_GPIO_MODE_INPUT_TRISTATE);
  /* Enable digital input. Only needed because P15.12 is an analog port */
  XMC_GPIO_EnableDigitalInput(P_BUT2);
}
